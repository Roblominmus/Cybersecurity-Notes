...
- Security goals and objectives
	- By setting goals and objectives organizations can reduce the risk of releasing confidential information i.e. PIIs (Personally Identifiable Information)
    
- Risk mitigation processes
	- This is having things in place to respond to , go against and or reduce the impact of  possible risks.
    
- Compliance
	- It is a method used to create an organization's security plan / playbook
    
- Business continuity plans
	- The plans set in place to pick up the business from the ground incase of the worst.
